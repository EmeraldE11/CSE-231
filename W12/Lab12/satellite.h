...
extern const double BULLET_RADIUS_PIXELS;
extern const double BULLET_RELATIVE_KICK;
extern const double BULLET_SPAWN_CLEARANCE_PIXELS;
extern const double SHIP_NOSE_OFFSET_PIXELS;
extern const double TIME_PER_FRAME;
extern const double ROTATION_PER_FRAME;
extern const int FRAGMENT_LIFETIME_FRAMES;
extern const int BULLET_LIFETIME_FRAMES;
extern const int BULLET_FIRE_COOLDOWN_FRAMES;
