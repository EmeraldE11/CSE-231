...
public:
   ...
   // getters
   virtual bool operator == (PieceType pt) const { return pt == getType(); }
   virtual bool operator != (PieceType pt) const { return pt != getType(); }
   virtual bool isWhite()                  const { return fWhite == true;  }
   virtual bool isMoved()                  const { return getNMoves();     }
...
public:
   ...
   PieceDerived(int c, int r, bool isWhite) : Piece(c, r)        { }
   ~PieceDerived()                                                       { }
